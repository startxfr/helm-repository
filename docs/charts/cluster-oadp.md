...
spec:
  description: Configure OpenShift Application Data Protection operator
  sourceRepos:
...
| 12.0.7 | 2023-08-18 | Upgrade to 1.1.5 OADP operator release |
...
| 15.27.9 | 2024-11-09 | Upgrade the OADP operator version to v1.4.1 |
...
| 18.11.9 | 2025-05-01 | Update OADP operator to version 1.4.4 |
