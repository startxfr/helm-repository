...
- **startx** : Compliance operator (see [values.yaml](https://bit.ly/HelmRepo/cluster-compliance/values-startx.yaml))

```bash
helm install startx/cluster-compliance -f https://bit.ly/HelmRepo/cluster-compliance/values-startx.yaml
```
