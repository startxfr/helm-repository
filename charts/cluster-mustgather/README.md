...
| -------- | ---------- | ------------------------------------------------------------------------------------------------------ |
| 0.3.19   | 2020-11-06 | Create chart cluster-mustgather from cluster-ocs                                                         |
...
| 0.3.151  | 2021-01-23 | Upgrade to MustGather version 4.6.0                                                                      |
...
| 0.3.226  | 2021-06-02 | Update mustgather operator (end of active support) to version 4.7.0                                      |
...
| 0.3.443  | 2021-07-27 | Update the mustgather operator to version 4.7.0-202107141046                                             |
...
| 8.20.67  | 2021-11-20 | Update mustgather operator to release 4.8.0-202111041632                                                 |
