...
- 1 **chaos** named **chaos-litmus** of **1 pod** running **quay.io/startx/fedora:latest** image
- 1 **service** named **chaos-litmus**
...
helm install startx/chaos-litmus -f https://raw.githubusercontent.com/startxfr/helm-repository/master/charts/example-sxapi/values-demo.yaml
```
...
- 1 **pod** named **chaos-litmus-apache** of **2 pods** running **quay.io/startx/apache:latest** image
- 1 **service** named **chaos-litmus-apache**

```bash
# Configuration running apache example configuration
helm install startx/chaos-litmus -f https://raw.githubusercontent.com/startxfr/helm-repository/master/charts/example-sxapi/values-apache.yaml
```
...
- 1 **pod** named **chaos-litmus-mariadb** of **2 pods** running **quay.io/startx/mariadb:latest** image
- 1 **service** named **chaos-litmus-mariadb**

```bash
# Configuration running mariadb example configuration
helm install startx/chaos-litmus -f https://raw.githubusercontent.com/startxfr/helm-repository/master/charts/example-sxapi/values-mariadb.yaml
```
...
| 10.12.9 | 2022-06-04 | Improve chaos-litmus options
...
| 10.12.7 | 2022-06-11 | Improve chaos-litmus options
