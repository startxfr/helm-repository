...
- **startx** : Couchbase operator (see [values.yaml](https://bit.ly/HelmRepo/cluster-couchbase/values-startx.yaml))

```bash
helm install startx/cluster-couchbase -f https://bit.ly/HelmRepo/cluster-couchbase/values-startx.yaml
```
