...
- 1 **service** named **example-catalog-prod** load balancing to pod deployed
- 1 **deployment** named **example-catalog-prod** deploying **1 pod** from version **0.3.52** sxapi image running the **prod:start** command with debug disabled
- 2 **configMap** holding sxapi configuration and pod environment variable context

```bash
# base configuration running tekton v1.0.1 configuration
helm install startx/example-catalog -f https://raw.githubusercontent.com/startxfr/helm-repository/master/charts/example-catalog/values-v0.0.1.yaml
```
...
- 1 **service** named **example-catalog-prod** load balancing to pod deployed
- 1 **deployment** named **example-catalog-prod** deploying **1 pod** from version **0.3.57** sxapi image running the **prod:start** command with debug disabled
- 2 **configMap** holding sxapi configuration and pod environment variable context

```bash
# base configuration running tekton v1.0.1 configuration
helm install startx/example-catalog -f https://raw.githubusercontent.com/startxfr/helm-repository/master/charts/example-catalog/values-v0.0.2.yaml
```
